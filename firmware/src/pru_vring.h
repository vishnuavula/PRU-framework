#ifndef _VRING_PRU_H_
#define _VRING_PRU_H_
#include <stdint.h>
#include <types.h>
...
void pru_vring_init(struct pru_vring *pvr, const char *name, const struct fw_rsc_vdev_vring *rsc_vring);
...
void pru_vring_push(struct pru_vring *pvr, const struct pru_vring_elem *pvre, u32 len);
